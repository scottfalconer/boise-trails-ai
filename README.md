...
| --- | --- | --- | --- | --- |
| 2026-06-19 | [Challenge day 1: Harrison Hollow 1B](years/2026/field-tests/challenge/2026-06-19-1b/) | `1B. Harrison Hollow` | 6.10 mi Strava run; local matcher found 12/12 planned segments plus extra `Buena Vista Trail 5`; `Buena Vista Trail 4` was a crossing/near-touch only. | The stale prod packet exposed `1B`, but the progress ledger now marks those 13 official segments complete and the regenerated packet no longer offers `1B` or `1755` as future new credit. |
| 2026-05-26 | [Pre-challenge repaired West Climb loop](years/2026/field-tests/pre-challenge/2026-05-26-fd12a-repaired/) | `FD12A. West Climb / Full Sail` | Door-to-door 1:32:23.89; 4.95 mi Strava run; local matcher found 9/9 tested route segments. | The active follow-up FD12A card now adds full `1579` credit and uses a compact 5.96-mile edge-cover line instead of the stale 11.65-mile West Climb field-day geometry. |
