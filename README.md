...
| --- | --- | --- | --- | --- |
| 2026-05-25 | [Pre-challenge test 05](years/2026/field-tests/pre-challenge/2026-05-25-fd12a-full-sail/) | `FD12A. Hillside to Hollow: Full Sail` / `112-1` | Field feedback captured; activity geometry still needs validation before progress is applied. Short available time plus hidden repeat burden left at least one segment uncompleted. | The card had one route truth for scaled phone cue mileage and another for live-map route anchors. Completion certification now fails when route-card mileage, cue mileage, and live-map route anchors do not reconcile. |
| 2026-05-21 | [Pre-challenge test 04](years/2026/field-tests/pre-challenge/2026-05-21-west-climb/) | `FD12A. West Climb` partial field check | 5.00 mi Strava run; local matcher found 8/21 planned segments complete, 5 partial, and no extra completed official segments. | The first corridor matched the route, but `FD12A` remains a high-repeat card: 10.61 on-foot mi for 7.85 official mi, 4.69 declared repeat mi, and 17 cues. Keep it as proven-current while testing any same-credit split/re-anchor candidate against a real savings threshold. |
