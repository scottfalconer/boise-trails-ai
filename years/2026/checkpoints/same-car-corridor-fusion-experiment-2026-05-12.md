...
Generated: 2026-05-12T22:32:55Z
...
- Paper-only fusion candidates: 2
- Total lower-bound saved on-foot miles: 6.39
- Existing route-card saved on-foot miles: 2.57
...
| Avimor Spring Creek microcard probe | 8.57 | 401/451 / 281/331 | 1.8 | `promotion_candidate_requires_recertification` | 7.08 | 297/334 / 179/214 | 1.49 mi / 104 p75 | simpler | not_promotable_until_route_card_claim_cue_promotion_and_recertification |
...
- `avimor-fd27a-fd27b-fd27c`: coverage `coverage_preserved_if_source_claim_promoted`, repeat/latent gate `requires_route_card_claim_and_cue_promotion`, ascent `passed_no_ascent_segments`.
