...
Generated: 2026-05-12T04:02:49Z
Status: `ownership_reassignment_reduces_existing_loop_work`

## Summary

- Routes audited: 50
- Ownership graph edges: 41
- Relevant components: 5
- Exact optimized relevant components: 5
- Reassigned official segments: 33 (15.27 mi)
- Order-free route cards: 29 -> 23 (6 removed)
- Order-free on-foot miles: 198.10 -> 184.37 (13.73 mi saved)
- Order-free p75/p90 saved: 536 / 604 min
- Current-calendar skip-ready savings: 4.39 mi, 147 p75 min, 166 p90 min
...
|---|---:|---:|---|---:|---:|---|
| C01 | 12 | 19 | 119-3: FD19C, 122-1: FD22A | 7.52 | 188 | 1 skip-ready, 1 need reorder |
| C02 | 5 | 6 | 127-3: FD27C, 127-1: FD27A | 3.50 | 222 | 2 need reorder |
| C04 | 4 | 4 | 114-3: FD14C, 114-1: FD14A | 2.71 | 126 | 1 skip-ready, 1 need reorder |
...
| 122-2: FD22B | 1532, 1533 | 1534, 1535 | 119-2: FD19B | 4.46 |
