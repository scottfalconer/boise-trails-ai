...
| shingle_exception_weekday_292_bound | False | True | 80 | 1574 | 0 | False The problem is infeasible. (HiGHS Status 8: model_status is Infeasible; primal_status is None) |  |  |
...
- Weekday-only loops / weekdays: 0 / 22
- Min weekday days for weekday-only loops: 0
...
- Weekday-only loops / weekdays: 27 / 22
- Min weekday days for weekday-only loops: 27
- Partition success: False
