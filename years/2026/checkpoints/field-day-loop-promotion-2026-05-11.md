...
| 10 | 2026-06-25 | 5 | `FD05A` | `personal_route_menu` | `hulls-gulch-interpretive` | 8th Street ATV Parking Area | 133 | preserved_existing_certified_card |
| 11 | 2026-06-25 | 5 | `4A` | `canonical_field_menu` | `bobs-trail-urban-connector` | Bob's | 97 | preserved_existing_certified_card |
| 12 | 2026-06-26 | 6 | `FD06A` | `personal_route_menu` | `fat-tire-traverse-curlew-connection` | Lower Interpretive | 220 | preserved_existing_certified_card |
| 13 | 2026-06-27 | 25 | `FD25A` | `personal_route_menu` | `elk-meadows-trail` | Simplot Lodge Parking Area | 171 | preserved_existing_certified_card |
| 14 | 2026-06-27 | 25 | `FD25B` | `personal_route_menu` | `the-face-trail` | Pioneer Lodge Parking Area | 160 | preserved_existing_certified_card |
| 15 | 2026-06-28 | 26 | `FD26A` | `personal_route_menu` | `around-the-mountain-trail` | Simplot Lodge Parking Area | 279 | preserved_existing_certified_card |
| 16 | 2026-06-29 | 7 | `FD07A` | `personal_route_menu` | `sunshine-xc` | Simplot Lodge Parking Area | 119 | preserved_existing_certified_card |
